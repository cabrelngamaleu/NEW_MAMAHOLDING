      ...
      <section className="bg-gradient-to-br from-red-500 to-red-700 text-white py-20">
        <div className="container-custom">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-center">CAC</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                CAC est spécialisé dans le commerce en gros de produits diversifiés. Nous offrons à nos clients professionnels un large choix de produits de qualité, accompagné d'un service personnalisé et efficace.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Grâce à notre expertise et notre réseau de distribution, nous garantissons à nos partenaires des solutions commerciales adaptées à leurs besoins spécifiques.
              </p>
